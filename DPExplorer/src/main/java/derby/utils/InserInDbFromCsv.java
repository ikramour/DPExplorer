...
public class InserInDbFromCsv {
	...
	public void insertCsvIntoDerbyDB(String csvPath, String [] headresCsv) throws SQLException, ParseException {
		CSVFormat csvFormat = CSVFormat.DEFAULT
				.builder()
				.setSkipHeaderRecord(true)
				.setDelimiter(";")
				.setHeader(headresCsv)
				.build();

		try (Reader reader = new FileReader(csvPath);CSVParser csvParser = new CSVParser(reader, csvFormat)) {
